...
export const typeConfig = {
    ...
    Payment:        { icon: ShoppingBag,   color: 'text-violet-600',  bg: 'bg-violet-50 dark:bg-violet-900/20', label: 'Payment' },
    Chat:           { icon: Info,          color: 'text-sky-500',     bg: 'bg-sky-50 dark:bg-sky-900/20',       label: 'Chat' },
    Admin:          { icon: AlertTriangle, color: 'text-purple-600',  bg: 'bg-purple-50 dark:bg-purple-900/20', label: 'Admin' },
