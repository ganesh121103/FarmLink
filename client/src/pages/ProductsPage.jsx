...
const ProductsPage = () => {
  ...
  // 1. SAFE REDUX SELECTION
  const { farmerProducts, loading } = useSelector((state) => state.products || {});
  
  // 2. Ensure products is always an array to prevent crashes
  const productsList = Array.isArray(farmerProducts) ? farmerProducts : [];
  ...
  // 3. FILTERING LOGIC (Fixes Infinite Loop)
  // We filter directly during render instead of setting state in useEffect
